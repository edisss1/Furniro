...
export const ModalHeader = ({ modalTitle, toggleDialog }: ModalHeaderProps) => {
  return (
    <div className="flex relative justify-between items-center mt-4 z-[1000] mb-12 after:content['*'] after:absolute after:w-full  after:h-[1px] after:bg-[#D9D9D9] after:-bottom-6">
